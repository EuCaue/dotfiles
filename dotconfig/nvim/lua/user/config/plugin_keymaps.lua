...
M.telescope = {
  ...
  },
  {
    ...
    "<cmd>Telescope<cr>",
    mode = "n",
    desc = "Telescope Builtins Options",
  },
  {
    "<leader>fa",
    "<cmd>lua require('search').open()<cr>",
    mode = "n",
    desc = "Search all things",
  },
}
...
M.harpoon = {
  ...
  },
  {
    ...
    mode = "n",
    desc = "Harpoon Go Next",
  },
  {
    "<leader>hp",
    "<cmd>lua require('harpoon.tmux-ui').nav_prev()<cr>",
    mode = "n",
    desc = "Harpoon Go Prev",
  },
  {
    "<leader>hc",
